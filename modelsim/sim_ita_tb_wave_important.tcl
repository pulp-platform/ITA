...
add wave -noupdate -expand -group {Masking Signals} -radix decimal /ita_tb/dut/i_requantizer/requant_oup_o
...
add wave -noupdate -expand -group {All in one Phase} -radix unsigned /ita_tb/dut/i_softmax_top/i_softmax/inp_stream_soft_o
add wave -noupdate -expand -group {All in one Phase} -radix decimal /ita_tb/dut/inp1
...
WaveRestoreCursors {{Cursor 1} {99296600 ps} 1} {{Cursor 2} {94544458 ps} 0}
...
update
WaveRestoreZoom {94475383 ps} {94588811 ps}
