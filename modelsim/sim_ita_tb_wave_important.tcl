...
add wave -noupdate -expand -group {All in one Phase} -radix unsigned /ita_tb/dut/inp1_q
...
WaveRestoreCursors {{Cursor 1} {10268600 ps} 1}
...
update
WaveRestoreZoom {0 ps} {23757930 ps}
