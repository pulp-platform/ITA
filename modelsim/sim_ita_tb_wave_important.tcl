...
add wave -noupdate -expand -group {Masking Signals} /ita_tb/dut/i_controller/calc_en_o
...
add wave -noupdate -expand -group {Masking Signals} -expand -group {In Softmax Module} /ita_tb/dut/i_softmax_top/i_softmax/calc_en_d
add wave -noupdate -expand -group {Masking Signals} -expand -group {In Softmax Module} /ita_tb/dut/i_softmax_top/i_softmax/calc_en_q1
add wave -noupdate -expand -group {Masking Signals} -expand -group {Masking Module} /ita_tb/dut/i_controller/i_masking/clk_i
add wave -noupdate -expand -group {Masking Signals} -expand -group {Masking Module} /ita_tb/dut/i_controller/i_masking/rst_ni
add wave -noupdate -expand -group {Masking Signals} -expand -group {Masking Module} /ita_tb/dut/i_controller/i_masking/ctrl_i
add wave -noupdate -expand -group {Masking Signals} -expand -group {Masking Module} /ita_tb/dut/i_controller/i_masking/step_i
add wave -noupdate -expand -group {Masking Signals} -expand -group {Masking Module} /ita_tb/dut/i_controller/i_masking/calc_en_i
add wave -noupdate -expand -group {Masking Signals} -expand -group {Masking Module} /ita_tb/dut/i_controller/i_masking/last_inner_tile_i
add wave -noupdate -expand -group {Masking Signals} -expand -group {Masking Module} /ita_tb/dut/i_controller/i_masking/count_i
add wave -noupdate -expand -group {Masking Signals} -expand -group {Masking Module} /ita_tb/dut/i_controller/i_masking/tile_x_i
add wave -noupdate -expand -group {Masking Signals} -expand -group {Masking Module} /ita_tb/dut/i_controller/i_masking/tile_y_i
add wave -noupdate -expand -group {Masking Signals} -expand -group {Masking Module} /ita_tb/dut/i_controller/i_masking/mask_o
add wave -noupdate -expand -group {Masking Signals} -expand -group {Masking Module} /ita_tb/dut/i_controller/i_masking/mask_col_offset_d
add wave -noupdate -expand -group {Masking Signals} -expand -group {Masking Module} /ita_tb/dut/i_controller/i_masking/mask_col_offset_q
add wave -noupdate -expand -group {Masking Signals} -expand -group {Masking Module} /ita_tb/dut/i_controller/i_masking/mask_tile_x_pos_d
add wave -noupdate -expand -group {Masking Signals} -expand -group {Masking Module} /ita_tb/dut/i_controller/i_masking/mask_tile_x_pos_q
add wave -noupdate -expand -group {Masking Signals} -expand -group {Masking Module} /ita_tb/dut/i_controller/i_masking/mask_tile_y_pos_d
add wave -noupdate -expand -group {Masking Signals} -expand -group {Masking Module} /ita_tb/dut/i_controller/i_masking/mask_tile_y_pos_q
add wave -noupdate -expand -group {Masking Signals} -expand -group {Masking Module} /ita_tb/dut/i_controller/i_masking/mask_pos_d
add wave -noupdate -expand -group {Masking Signals} -expand -group {Masking Module} /ita_tb/dut/i_controller/i_masking/mask_pos_q
add wave -noupdate -expand -group {Masking Signals} -expand -group {Masking Module} /ita_tb/dut/i_controller/i_masking/mask_d
add wave -noupdate -expand -group {Masking Signals} -expand -group {Masking Module} /ita_tb/dut/i_controller/i_masking/mask_q
...
add wave -noupdate /ita_tb/dut/i_softmax_top/i_softmax/inner_tile_i
add wave -noupdate /ita_tb/dut/i_softmax_top/i_softmax/inner_tile_q
...
add wave -noupdate /ita_tb/dut/i_softmax_top/i_softmax/mask_tile_x_d
...
add wave -noupdate -group Controller /ita_tb/dut/i_controller/bias_tile_x_q
...
add wave -noupdate -group Controller /ita_tb/dut/i_controller/bias_tile_y_q
...
add wave -noupdate -group Controller /ita_tb/dut/i_controller/requant_add
...
add wave -noupdate -group {Softmax Controller} /ita_tb/dut/i_softmax_top/i_softmax/mask_tile_outer_dim_d
add wave -noupdate -group {Softmax Controller} /ita_tb/dut/i_softmax_top/i_softmax/mask_tile_outer_dim_q
