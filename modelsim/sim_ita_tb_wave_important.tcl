...
add wave -noupdate -expand -group Softmax /ita_tb/dut/i_softmax_top/i_softmax/requant_oup_q
...
add wave -noupdate -expand -group Accumulator /ita_tb/dut/i_accumulator/clk_i
add wave -noupdate -expand -group Accumulator /ita_tb/dut/i_accumulator/rst_ni
add wave -noupdate -expand -group Accumulator /ita_tb/dut/i_accumulator/calc_en_i
add wave -noupdate -expand -group Accumulator /ita_tb/dut/i_accumulator/calc_en_q_i
add wave -noupdate -expand -group Accumulator /ita_tb/dut/i_accumulator/first_tile_i
add wave -noupdate -expand -group Accumulator /ita_tb/dut/i_accumulator/first_tile_q_i
add wave -noupdate -expand -group Accumulator /ita_tb/dut/i_accumulator/last_tile_i
add wave -noupdate -expand -group Accumulator /ita_tb/dut/i_accumulator/last_tile_q_i
add wave -noupdate -expand -group Accumulator /ita_tb/dut/i_accumulator/inp_bias_i
add wave -noupdate -expand -group Accumulator /ita_tb/dut/i_accumulator/read_en
add wave -noupdate -expand -group Accumulator /ita_tb/dut/i_accumulator/read_addr
add wave -noupdate -expand -group Accumulator /ita_tb/dut/i_accumulator/read_data
add wave -noupdate -expand -group Accumulator /ita_tb/dut/i_accumulator/read_data_unused
add wave -noupdate -expand -group Accumulator /ita_tb/dut/i_accumulator/write_en
add wave -noupdate -expand -group Accumulator /ita_tb/dut/i_accumulator/write_addr
add wave -noupdate -expand -group Accumulator /ita_tb/dut/i_accumulator/write_data
add wave -noupdate -expand -group Accumulator /ita_tb/dut/i_accumulator/read_addr_d
add wave -noupdate -expand -group Accumulator /ita_tb/dut/i_accumulator/read_addr_q
add wave -noupdate -expand -group Accumulator /ita_tb/dut/i_accumulator/write_addr_d
add wave -noupdate -expand -group Accumulator /ita_tb/dut/i_accumulator/write_addr_q
add wave -noupdate -expand -group Accumulator /ita_tb/dut/i_accumulator/result_q
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {414600 ps} 1} {{Cursor 2} {550600 ps} 1} {{Cursor 3} {710600 ps} 1} {{Cursor 4} {390540 ps} 0}
...
update
WaveRestoreZoom {371422 ps} {416865 ps}
